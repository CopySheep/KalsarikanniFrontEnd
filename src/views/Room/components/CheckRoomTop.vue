    ...
    setup() {
        ...
        function redirectToCheckRoom() {
            ...
            if (selectedDate) {
                ...
                router.push({ path: 'detail', query: { b_date: formattedStartDate, e_date: formattedEndDate,orgin_date:selectedDate } });
            }
        }
...
<template>
    <!-- Check rooms -->
    <div id="checkRoomTop" class="check-room-top pt-4 pb-4 pt-lg-0 pb-lg-0">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-5">
                            <form class="row g-4" method="post" action="./detail">
                                <div class="col-12 col-lg-5 col-md-7">
                                    ...
                                    <div class="mb-0">
                                        <div class="position-relative">
                                            ...
                                            <input id="txtCheckDate" type="text" class="check-date form-select bg-body-tertiary cursor-pointer shadow-none ps-11 fw-medium" placeholder="" readonly="false">
                                        </div>
                                    </div>
                                    <!-- /Input date -->
                                </div>
                                ...
                                <div class="col-12 col-lg-3 col-md-12">
                                    <!-- Button -->
                                    <div class="mb-0">
                                        <div class="btn btn-primary w-100 fw-medium" @click="redirectToCheckRoom">
